...
console.log("("+stringArray1.length+") [\""+stringArray1[0]+"\", \""+stringArray1[1]+"\"]");
console.log("("+variableArray1.length+") ["+variableArray1[0]+","+variableArray1[1]+","+variableArray1[2]+",Array("+numberArray1.length+"),Array("+stringArray1.length+")]");
...
console.log("("+numberArray1.length+") ["+numberArray1+"]");
console.log("("+numbersGreaterThan2.length+") ["+numbersGreaterThan2+"]");
console.log("("+evenNumbers.length+") ["+evenNumbers+"]");
